...
use_scm = {"write_to": "napari_compressed_labels_io/_version.py"}
...
setup(
    ...
    license='MIT',
    url='https://github.com/DragaDoncila/napari-compressed-labels-io',
    ...
    entry_points={
        'napari.plugin': [
            'napari-compressed-labels-io = napari_compressed_labels_io',
        ],
    },
)
